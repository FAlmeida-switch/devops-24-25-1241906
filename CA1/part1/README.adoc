...
Created the DevOps repository (devops-24-25-1241906) through the git bash terminal and then
and proceeded to create inside it the folders
CA1/part1.
Imported the basic folder asw   ell as the pom.xml from the Tutorial React.js and Spring Data REST to the
part1 folder.
